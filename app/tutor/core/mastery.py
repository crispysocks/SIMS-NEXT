...
class MasteryState:
    ...
    Prior: Beta(3, 3) �?symmetric, mean 0.5, high initial uncertainty.
    After each answer: correct �?alpha += 1, wrong �?beta += 1.
    """
    ...
    def mastery(self) -> float:
        """Posterior mean �?estimated probability of correct answer."""
        return self.alpha / (self.alpha + self.beta)

    @property
    def variance(self) -> float:
        """Posterior variance �?higher means less confident.
