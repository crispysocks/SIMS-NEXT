...
export const api = {
  ...
  postStream: (endpoint: string, data: unknown, token?: string): Promise<ReadableStream<Uint8Array>> =>
    apiFetchStream(endpoint, { method: 'POST', body: JSON.stringify(data), token }),
