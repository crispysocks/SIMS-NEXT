...
Usage:
    from app.rag.factory import create_pipeline, RAGConfig
...
from app.core.tutoring import TutoringPipeline
...
class RAGConfig:
    ...
    kb_path: str = "app/subjects/english/knowledge_base"
    ...
    def from_env(cls) -> RAGConfig:
        return cls(
            ...
            kb_path=os.environ.get("RAG_KB_PATH", "app/subjects/english/knowledge_base"),
...
def _build_rag(config: RAGConfig) -> TutoringPipeline:
    ...
    from app.rag.llm_explanation_generator import LLMExplanationGenerator
    from app.rag.rag_tutoring_pipeline import RAGTutoringPipeline
